...
export default{
    ...
    fetchRomanceMovies:`/discover/movie?api_key=${API_KEY}&with_genres=10749&language=ta&year=2022`,
    ...
    fetchMore:`/discover/movie?api_key=${API_KEY}&language=ta&year=2022`,
}