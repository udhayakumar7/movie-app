...
<div className='home banner' >
   <Slider className='w-full '  {...settings}>
      ...
      return(
      <div key={i}>
         <div className=' md:h-80  lg:h-80 xl:h-h-banner h-52 bg-cover  bg-no-repeat ' style={{backgroundImage: `url("https://image.tmdb.org/t/p/original/${moviedata?.backdrop_path  || moviedata?.poster_path } ")`, backgroundPosition: 'top center',borderRadius:'10px'}}>
